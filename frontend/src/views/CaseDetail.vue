  ...
  <div class="page">
    ...
    <div class="panel">
      ...
      <el-form label-width="90px">
        <el-form-item label="审核结论"><el-select v-model="review.review_result" :disabled="!isPending"><el-option label="已通过" value="approved" /><el-option label="已拒绝" value="rejected" /></el-select></el-form-item>
